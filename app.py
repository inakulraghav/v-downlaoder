...
BYPASS_OPTIONS = {
    ...
    'cookiefile': 'cookies.txt',  # Teri chaabi yahan kaam aayegi
    
    # Android hata kar wapas 'web' client kar diya
    'extractor_args': {'youtube': {'player_client': ['web']}},
    
    'http_headers': {
        'X-Forwarded-For': '103.15.111.0',
        # Wapas PC (Windows/Chrome) ka User-Agent laga diya
