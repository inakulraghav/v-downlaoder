...
def fetch_info():
    ...
    try:
        ...
        ydl_opts['format'] = 'best' # Sirf check karte time best available utha lega
        ydl_opts['ignore_no_formats_error'] = True # Audio-only video par crash nahi hone dega
        # Yahan format ki koi strictness nahi lagayenge, yt-dlp ko poori info laane denge
